...
public class discounts {
	...
	public static void main(String[] args) {
		...
		if(quantity < 100) {
			...
			System.out.println("After discount: Sorry, no discount for less than 100 units");
		}
		if((quantity >=100) && (quantity < 120)) {
			discount = (revenue * 15) / 100; 
			afterDiscount = revenue - discount; 
			System.out.println("The revenue from sale is " + revenue);
			System.out.println("After discount: " + afterDiscount + "(15%)");
		...
		if(quantity > 120) {
			...
			afterDiscount = revenue - discount; 
			System.out.println("The revenue from sale is " + revenue);
			System.out.println("After discount: " + afterDiscount + "(20%)");
		}
